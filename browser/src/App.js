...
const navLinks = [
  {
    ...
    Icon: () => (
      <svg
        ...
        className='feather feather-circle nav-icon'
      >
  ...
  },
  {
    ...
    Icon: () => (
      <svg
        ...
        strokeLinecap='round'
        strokeLinejoin='round'
        className='feather feather-home nav-icon'
      >
  ...
  },
  {
    ...
    Icon: () => (
      <svg
        ...
        strokeLinecap='round'
        strokeLinejoin='round'
        className='feather feather-layers nav-icon'
      >
  ...
  },
  {
    ...
    Icon: () => (
      <svg
        ...
        strokeLinecap='round'
        strokeLinejoin='round'
        className='feather feather-settings nav-icon'
      >
